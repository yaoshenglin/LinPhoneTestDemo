...
foreach(comp ${BcToolbox_FIND_COMPONENTS})
	...
	if(TARGET ${targetname})
		...
		if(LINPHONE_BUILDER_GROUP_EXTERNAL_SOURCE_PATH_BUILDERS)
			...
			list(INSERT BCTOOLBOX_${uppercomp}_INCLUDE_DIRS 0 "/Volumes/SSD/workspace_mac/linphone-ios-liblinphone-tester/liblinphone-sdk/x86_64-apple-darwin.ios/include")
		endif()
