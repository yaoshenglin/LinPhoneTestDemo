 ...
 * @param[in]   buffer			[in/out]Buffer to place error string representation
 ...
 * @param[in]   output_length	[in/out]output buffer max size and actual size of buffer after encoding
 ...
 * @param[in]   output_length	[in/out]output buffer max size and actual size of buffer after decoding
 ...
 *
 * @param[in]   context			[in/out]The RNG context to be used
 ...
 *
 * @param[in]   key				[in/out]An already initialised signing key context
 ...
 *
 * @param[in]	cert		[in/out]An already initialised x509 certificate context
 ...
 *
 * @param[in]	cert	[in/out]points to the start of the chain, can be an empty initialised certificate context
 ...
 *
 * @param[in]		cert		The certificate chain
 * @param[in]	buffer		[in/out]The buffer to hold the certificate
 ...
 *
 * @param[in]		cert		The x509 certificate
 * @param[in]	dn		[in/out]A buffer to store the DN string
 ...
 *
 * @param[in]		cert			The x509 certificate
 * @param[in]	fingerprint		[in/out]The buffer to hold the fingerprint(null terminated string in hexadecimal)
 ...
 * @param[in]	certificate	[in/out]An empty intialised certificate pointer to hold the generated certificate
 * @param[in]	pkey		[in/out]An empty initialised signing key pointer to hold the key generated and used to sign the certificate (RSA 3072 bits)
 ...
 *
 * @param[in]	flags		[in/out]The certificate flags holder directly provided by crypto library in a callback function
 ...
 *
 * @param[in] 	context		[in/out]DHM context, will store the public value in ->self after this call
 ...
 *
 * @param[in] 	context		[in/out]Read the public values from context, export the key to context->key
 ...
 *
 * @param[in]	context			[in/out]a context already initialized using bctbx_aes_gcm_context_new
