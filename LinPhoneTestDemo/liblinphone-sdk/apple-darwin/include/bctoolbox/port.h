 ...
 * @param[in]   ret [out]The current time (seconds and nano seconds).
 */
 ...
 *
 * @param[in]	ret	[out]The current UTC time, (seconds and nano seconds)
 */
 ...
 *
 * @param[in]	ts	[out]The timeSpec structure used as input, modified in output by increnting it according to second argument
