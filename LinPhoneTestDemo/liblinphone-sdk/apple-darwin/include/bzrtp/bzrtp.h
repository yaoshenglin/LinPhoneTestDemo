 ...
 * @param[in]	context				[out]The zrtp context to set the callback function
 ...
 * @param[in]	zrtpContext		[out]The ZRTP context we're dealing with
 ...
 * @param[in]	zrtpContext		[in/out]The ZRTP context we're dealing with
 * @param[in]		selfSSRC		The SSRC identifying the channel to be linked to the client Data
 ...
 *
 * @param[in]	zrtpContext	[in/out]The zrtp context who will get the additionnal channel
 ...
 *
 * @param[in]	zrtpContext			[in/out]The ZRTP context hosting the channel to be started
 ...
 *
 * @param[in]	zrtpContext			[in/out]The ZRTP context hosting the channel
