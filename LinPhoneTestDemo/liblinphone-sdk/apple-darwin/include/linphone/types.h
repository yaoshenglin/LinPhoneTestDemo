...
typedef enum _LinphoneCallState{
	LinphoneCallIdle = 0, /**< Initial call state */
	LinphoneCallIncomingReceived = 1, /**< This is a new incoming call */
	LinphoneCallOutgoingInit = 2, /**< An outgoing call is started */
	LinphoneCallOutgoingProgress = 3, /**< An outgoing call is in progress */
	LinphoneCallOutgoingRinging = 4, /**< An outgoing call is ringing at remote end */
	LinphoneCallOutgoingEarlyMedia = 5, /**< An outgoing call is proposed early media */
	LinphoneCallConnected = 6, /**< Connected, the call is answered */
	LinphoneCallStreamsRunning = 7, /**< The media streams are established and running */
	LinphoneCallPausing = 8, /**< The call is pausing at the initiative of local end */
	LinphoneCallPaused = 9, /**< The call is paused, remote end has accepted the pause */
	LinphoneCallResuming = 10, /**< The call is being resumed by local end */
	LinphoneCallRefered = 11, /**< The call is being transfered to another party, resulting in a new outgoing call to follow immediately */
	LinphoneCallError = 12, /**< The call encountered an error */
	LinphoneCallEnd = 13, /**< The call ended normally */
	LinphoneCallPausedByRemote = 14, /**< The call is paused by remote end */
	LinphoneCallUpdatedByRemote = 15, /**< The call's parameters change is requested by remote end, used for example when video is added by remote */
	LinphoneCallIncomingEarlyMedia = 16, /**< We are proposing early media to an incoming call */
	LinphoneCallUpdating = 17, /**< A call update has been initiated by us */
	LinphoneCallReleased = 18, /**< The call object is no more retained by the core */
	LinphoneCallEarlyUpdatedByRemote = 19, /**< The call is updated by remote while not yet answered (early dialog SIP UPDATE received) */
	LinphoneCallEarlyUpdating = 20 /**< We are updating the call while not yet answered (early dialog SIP UPDATE sent) */
} LinphoneCallState;
