...
enum _MSFilterFlags{
	...
	MS_FILTER_IS_ENABLED = 1<<31 /**< to specify if a filter is enabled or not. Only enabled filters are returned by function ms_filter_get_encoder */
};
