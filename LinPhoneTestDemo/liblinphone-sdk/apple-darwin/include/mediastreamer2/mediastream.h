 ...
 * @param factory factory
 * @param ip local ip to listen for RTP packets. Can be ::, O.O.O.O or any ip4/6 addresses
 * @param loc_rtp_port the local UDP port to listen for RTP packets.
 * @param loc_rtcp_port the local UDP port to listen for RTCP packets
 * @return a new AudioStream.
**/
 ...
 * @param stream The audio stream.
 * @param volume Percentage of the max supported volume gain. Valid values are in [0.0 : 1.0].
 */
 ...
 * @param ip the local ip to listen for RTP packets. Can be ::, O.O.O.O or any ip4/6 addresses
 ...
 * @param filter the filter for this camera. It can be obtained with ms_web_cam_create_reader(cam)
 ...
 * @param[in] loc_rtp_port The local port to bind the RTP socket to.
 * @param[in] loc_rtcp_port The local port to bind the RTCP socket to.
 */
