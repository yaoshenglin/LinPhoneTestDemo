 ...
 * @param[in]   ctx [out]the opaque MSZRTP context
 */
 ...
 * @param[out]  output	The Zrtp Hello Hash as defined in RFC6189 section 8
 */
 ...
 * @param[in]	ctx	MSZRTP context
 * @param[in]   peerHelloHashHexString The Zrtp Hello Hash as defined in RFC6189 section 8
 * @param[in]   peerHelloHashHexStringLength The Zrtp Hello Hash length
 *
