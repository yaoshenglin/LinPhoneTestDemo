...
typedef enum _UCSCallState{
    ...
    UCSCallOutgoingEarlyMedia, /**<An outgoing call is proposed early media 5*/
    UCSCallConnected, /**<通话连接成功*/
    UCSCallStreamsRunning, /**媒体流已建立*/
    UCSCallPausing, /**<通话暂停中 */
    UCSCallPaused, /**< 通话暂停成功*/
    UCSCallResuming, /**<通话被恢复 10*/
    UCSCallRefered, /**通话转移*/
    UCSCallError, /**<通话错误*/
    UCSCallEnd, /**<通话正常结束*/
    UCSCallPausedByRemote, /**<通话被对方暂停*/
    UCSCallUpdatedByRemote, /**<对方请求更新通话参数 15*/
    ...
    UCSCallEarlyUpdating, /**<通话未应答我方 20*/
