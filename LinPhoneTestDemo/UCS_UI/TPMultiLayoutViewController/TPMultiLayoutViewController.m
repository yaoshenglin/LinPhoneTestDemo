...
- (void)addAttributesForSubviewHierarchy:(UIView*)view associatedWithSubviewHierarchy:(UIView*)associatedView toTable:(NSMutableDictionary*)table
{
    [table setObject:[self attributesForView:view] forKey:[NSValue valueWithPointer:(__bridge const void * _Nullable)(associatedView)]];
...
- (void)applyAttributeTable:(NSDictionary*)table toViewHierarchy:(UIView*)view
{
    NSDictionary *attributes = [table objectForKey:[NSValue valueWithPointer:(__bridge const void * _Nullable)(view)]];
    if ( attributes ) {
