...
static const CGFloat CSToastOpacity             = 0.72;     //显示框背景透明度
...
NSString *const Position_Top = @"top";//定义指针常量
NSString *const Position_Center = @"center";
...
- (void)makeToast:(NSString *)message
{
    ...
    [self makeToast:message duration:CSToastDefaultDuration position:Position_Bottom];
}
...
- (void)makeToast:(NSString *)message duration:(CGFloat)interval
{
    ...
    toast.hidden = YES;
    [toast removeFromSuperview];
    [self makeToast:message duration:interval position:Position_Bottom];
}
